...
function Therapy() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-black to-black">
      <div className="w-full h-[847px] min-w-[320px] lg:bg-cover md:bg-cover sm:bg-cover bg-cover bg-therapy-page bg-center bg-no-repeat flex flex-col items-center justify-center ">
