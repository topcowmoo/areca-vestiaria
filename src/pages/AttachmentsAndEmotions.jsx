  ...
  return (
    <div className="relative flex flex-col min-h-screen bg-black">
      ...
      <div className="relative w-full h-[847px] min-w-[320px]">
        <div className="absolute inset-0 w-full h-full bg-attachment-page bg-no-repeat bg-contain md:[background-position-y:0%] lg:[background-position-y:-10%] z-0"></div>
