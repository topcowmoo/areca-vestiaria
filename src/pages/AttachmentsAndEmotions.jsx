  ...
  return (
    <div className="relative flex flex-col min-h-screen bg-black">
      ...
      <div className="relative w-full h-[847px] min-w-[320px]">
        <div className="absolute inset-0 w-full h-full bg-testemotion opacity-50 bg-no-repeat bg-cover [background-position-x:50%] [background-position-y:-280px] md:[background-position-y:-430px] lg:[background-position-y:-600px] xl:[background-position-y:-850px] 2xl:[background-position-y:-1850px] z-0"></div>
