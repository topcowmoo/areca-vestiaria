  ...
  return (
    <div className="relative flex flex-col min-h-screen bg-black">
      ...
      <div className="relative w-full h-[847px] min-w-[320px]">
        <div className="absolute inset-0 w-full h-full bg-testtall opacity-50 bg-no-repeat bg-cover [background-position-x:75%] [background-position-y:-100px] md:[background-position-y:-175px] lg:[background-position-y:-290px] xl:[background-position-y:-325px] 2xl:[background-position-y:-375px] z-0"></div>
